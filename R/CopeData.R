...
get_child_dob <- function(token) {
  ...
  dobs$bio_dob <- ifelse(dobs$bio_dob > Sys.Date() | dobs$bio_dob < min_date, NA_real_, dobs$bio_dob)
  dobs$mhx_babydob_1 <- ifelse(dobs$mhx_babydob_1 > Sys.Date() | dobs$mhx_babydob_1 < min_date, NA_real_, dobs$mhx_babydob_1)
  dobs$mhx_babydob_2 <- ifelse(dobs$mhx_babydob_2 > Sys.Date() | dobs$mhx_babydob_2 < min_date, NA_real_, dobs$mhx_babydob_2)
